       ...
       <div class="flex mx-5">
         <div class="flex flex-col space-y-3 w-1/2 px-3 right-shadow text-white text-lg">
           ...
           <div class="flex space-x-3 bg-primary p-2 rounded-xl space-x-3">
             <svg xmlns="http://www.w3.org/2000/svg"  fill="currentColor" class="bi bi-newspaper w-32" viewBox="0 0 16 16">
           ...
           <div class="flex bg-primary p-2 rounded-xl space-x-3">
             <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-people-fill w-32" viewBox="0 0 16 16">
           ...
           <div class="flex bg-primary p-2 rounded-xl space-x-3">
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-file-image w-32" viewBox="0 0 16 16">
           ...
           <div class="flex bg-primary p-2 rounded-xl space-x-3">
             <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-mortarboard-fill w-28" viewBox="0 0 16 16">
